//Made from scratch by Retículo Endoplasmático#5955 (CaféDeColombiaFPS)
untyped
...
///CONFIGS///
const float TOTALRADIUS = 512 //hardcoded don't change until props are resized properly
